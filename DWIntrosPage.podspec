#
#  Be sure to run `pod spec lint DWGuidePage.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.author             = { "idwyane" => "dwadeisthebest@163.com" }
  s.author    = "Dwyane"
  # s.authors            = { "idwyane" => "dwadeisthebest@163.com" }
  # s.social_media_url   = "http://twitter.com/idwyane"
  ...
  s.source_files  = "DWGuidePage", "Source/*.{h,m}"
